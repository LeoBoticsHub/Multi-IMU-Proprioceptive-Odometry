disp("read rosbag");
bagFolder = '/home/edoardo/OneDrive/Desktop/Tesi/Leonardo/Equations_Validation/trot_contact'; % create the path for the ros2 bag
...
if ~isempty(messages) %we use the joint readings
    time_list = [];
    joint_ang_list = [];
    joint_vel_list = [];
...
dt=min([dt1,dt2,dt3,dt4,dt5,dt6,dt7]);% delate ,dt7 if there is no contact sensor
...
original_ts_names = {'acc_b_IMU', 'om_b_IMU', 'acc_fl_IMU', 'om_fl_IMU', ...
                     ...
                     'acc_rr_IMU', 'om_rr_IMU', 'j_ang', 'j_vel','foot_contact'}; % delate ,'foot_contact' if there is no contact sensor
